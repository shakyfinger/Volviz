...
garch_desc.textContent = "The Generalized Autoregressive Conditional Heteroskedasticity (GARCH) model is commonly used in volatility modeling as its autoregressive component is able to capture clustering of high and low volatility as well as time-varying conditional variance, unlike in other models where volatility is commonly assumed to be constant, namely the Geometric Brownian Motion. This plot shows the backward-looking realized 7-day rolling volatily against forward looking 30-day GARCH model predictions for volatility. The model was trained on the first 498 days of data and the predictions for the subsequent 30-days are plotted against the realized volatility."
